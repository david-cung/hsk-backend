...
class Profile(TimestampMixin, Base):
    ...
    daily_goal_type: Mapped[str] = mapped_column(String(20), default="minutes", server_default="minutes")
...
class Conversation(TimestampMixin, Base):
    ...
    __table_args__ = (
        ...
        Index("ix_conversations_user_mode", "user_id", "mode"),
        CheckConstraint("hsk_level BETWEEN 1 AND 6", name="ck_conversations_hsk_level"),
    )
...
class ConversationMessage(Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            "conversation_id",
            "idempotency_key",
            name="uq_conversation_messages_idempotency",
        ),
...
class AiUsageEvent(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_ai_usage_events_operation_created", "operation", "created_at"),
    )
...
class LearningEvent(Base):
    ...
    __table_args__ = (
        UniqueConstraint("user_id", "event_type", "source_key", name="uq_learning_events_idempotency"),
...
class XPTransaction(Base):
    ...
    __table_args__ = (
        UniqueConstraint("user_id", "event_type", "source_key", name="uq_xp_transactions_idempotency"),
        Index("ix_xp_transactions_user_created", "user_id", "created_at"),
        CheckConstraint("xp >= 0", name="ck_xp_transactions_non_negative"),
    )
...
class UserDailyActivity(TimestampMixin, Base):
    __tablename__ = "user_daily_activity"
    __table_args__ = (
        UniqueConstraint("user_id", "local_date", name="uq_user_daily_activity_day"),
        Index("ix_user_daily_activity_user_date", "user_id", "local_date"),
    )
    ...
    exercises: Mapped[int] = mapped_column(Integer, default=0, server_default="0")
    lessons: Mapped[int] = mapped_column(Integer, default=0, server_default="0")
    reviews: Mapped[int] = mapped_column(Integer, default=0, server_default="0")
    goal_completed: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false")
...
class DeviceToken(TimestampMixin, Base):
    ...
    platform: Mapped[str] = mapped_column(String(20), default="local", server_default="local")
...
class NotificationPreference(TimestampMixin, Base):
    ...
    id: Mapped[int] = mapped_column(primary_key=True)
    user_id: Mapped[int] = mapped_column(ForeignKey("users.id", ondelete="CASCADE"), unique=True)
    daily_reminder: Mapped[bool] = mapped_column(Boolean, default=True, server_default="true")
    streak_reminder: Mapped[bool] = mapped_column(Boolean, default=True, server_default="true")
    srs_reminder: Mapped[bool] = mapped_column(Boolean, default=True, server_default="true")
    exam_reminder: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false")
    achievement_notification: Mapped[bool] = mapped_column(Boolean, default=True, server_default="true")


class NotificationLog(Base):
    __tablename__ = "notification_logs"
    __table_args__ = (
        UniqueConstraint("user_id", "kind", "local_date", name="uq_notification_logs_dedupe"),
    )
